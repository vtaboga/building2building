...
def search_idf(state: str, county: str, building_type: str, area: float, num_floors: int, height: float|None, n_buildings: int, n_weather_files: int, keep_original: bool = False) -> Tuple[list[Tuple[str, dict]], list[str]]:
    """
    ...
    try:
        ...
        processed_files = process_idf(building_files, state, county, keep_original=keep_original)
