...
def make_controllable(
    ...
    def make_controllable_builder(input: Path):
        ...
        json_obj, waterheater_actuators = make_waterheater_controllable(json_obj)
        json_obj, pump_actuators = make_pump_controllable(json_obj)
        json_obj, airterminal_actuators = make_airterminal_controllable(json_obj)
        json_obj, controller_outdoorair_actuators = make_controller_outdoorair_controllable(json_obj)
