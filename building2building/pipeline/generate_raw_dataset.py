...
This module is the modernised replacement for the ad-hoc
``scripts/generate_dataset.py`` that was deleted in commit ``1f57775``
(April 2026).  The LHS logic and parameter ranges are lifted verbatim
from the last committed version of that script (commit ``def97d8``).

Phase G, item G2 (see TODO.md § G2).
...
Per AGENTS.md: never sbatch from the agent; write the script and tell
