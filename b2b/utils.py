...
def hydroquebec_building_id_from_split_index(
    ...
    *,
    ...
    IMPORTANT:
    The stored split lists are dataset row indices (0-based). HydroQuebec building ids
    are 1-based and correspond to filenames like `IDFsAndSchedules/<id>/...`.
...
def select_hydroquebec_buildings_by_row_id_split(
    ...
    *,
    ...
    # with a default 0..N-1 index. The stored values are dataset row indices (0-based)
    # and map directly to `.iloc[row_index]`.
