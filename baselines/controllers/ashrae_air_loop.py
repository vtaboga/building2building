...
class AshraeAirLoopPolicy:
    """ASHRAE-style VAV baseline for central air-loop buildings.

    Usage::

        cfg = AshraeAirLoopConfig()
    ...
    def __init__(self, cfg: AshraeAirLoopConfig | None = None) -> None:
        self.config = cfg or AshraeAirLoopConfig()
    ...
    def bind_env(self, env: Any) -> None:
        ...
        if not vav_systems:
            raise RuntimeError(
                "AshraeAirLoopPolicy requires VAVSystem equipment. "
