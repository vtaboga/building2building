...
class UnitaryG36Policy:
    ...
    Usage::
        ...
        cfg = UnitaryG36Config(heating_setpoint_c=20, cooling_setpoint_c=22)
    ...
    def __init__(self, cfg: UnitaryG36Config | None = None) -> None:
        if cfg is None:
            cfg = UnitaryG36Config()
